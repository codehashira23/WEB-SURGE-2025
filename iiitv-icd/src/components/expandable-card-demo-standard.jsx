        ...
        {active && typeof active === "object" ? (
          <div className="fixed inset-0 grid place-items-center z-[100]">
            ...
            <motion.div
              ...
              ref={ref}
              className="w-full max-w-[800px] h-[90vh] md:h-auto md:max-h-[90vh] flex flex-col bg-white dark:bg-neutral-900 sm:rounded-3xl overflow-hidden">
              ...
              <div className="flex-1 overflow-hidden">
                ...
                <div className="pt-4 relative px-6 overflow-y-auto max-h-[calc(90vh-24rem)] md:max-h-[40vh]">
                  <motion.div
                    layout
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    exit={{ opacity: 0 }}
                    className="text-neutral-600 text-base md:text-lg lg:text-xl pb-10 flex flex-col items-start gap-4 dark:text-neutral-400">
