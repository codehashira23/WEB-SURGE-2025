    ...
    <footer className="bg-[#800000] text-white mt-8">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Campus Address */}
          <div>
            <h3 className="text-lg font-semibold mb-4">Campus Address</h3>
            <p className="text-sm leading-relaxed">
              IIIT Vadodara - International Campus Diu (IIITV-ICD)<br />
              Education Hub, Kevdi<br />
              Diu (U.T) - 362520
            </p>
            <div className="mt-4">
              <p className="text-sm">
                <strong>Phone:</strong> +91 79905 73335 / 9265647473
              </p>
              <p className="text-sm">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/hostel" className="hover:underline">
                  Hostel
                </Link>
              </li>
              <li>
                <Link href="/tender" className="hover:underline">
                  Tender
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <p className="text-sm">
              <a href="https://www.google.com/maps/place/Education+Hub/@20.7190097,70.9368571,17z/" target="_blank" rel="noopener noreferrer" className="hover:underline">
                View on Google Maps
              </a>
            </p>
          </div>
